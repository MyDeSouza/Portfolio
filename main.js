...
(function () {
  ...
  requestAnimationFrame(function () {
    ...
    requestAnimationFrame(function () {
      ...
      // Phase 2 – hold, then Hi,I’m slides off, then Max DeSouza shrinks to topbar
      setTimeout(function () {
        ...
        requestAnimationFrame(function () {
          ...
          requestAnimationFrame(function () {
            ...
            // Step 2: once Hi,I’m is gone, fly Max DeSouza to topbar
            setTimeout(function () {
              ...
              // Hero text slides in as mark arrives
              setTimeout(function () {
                var hDisplay = document.querySelector(‘.h-display’);
                if (hDisplay) {
              ...
              // After mark lands: clean up + font-weight + content
              setTimeout(function () {
                markEl.style.transition      = ‘’;
            ...
            }, 500); // after Hi,I’m wipe completes
          });
        });
